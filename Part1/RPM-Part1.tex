...
\begin{frame}{Nearly 40 years of development}
  \begin{figure}%
      \centering
      \subfloat{{\includegraphics[width=0.27\textwidth]{figure/NewSlanguage} }}%
      \qquad
      \subfloat{{\includegraphics[width=0.27\textwidth]{figure/StatisticalModelsinS} }}%
      \qquad
      \subfloat{{\includegraphics[width=0.27\textwidth]{figure/Soda} }}
      \label{fig:example}%
  \end{figure}
\end{frame}
...
\begin{figure}%
    \centering
    \subfloat{{\includegraphics[width=0.27\textwidth]{figure/ComputationalActuarialScience} }}%
    \qquad
    \subfloat{{\includegraphics[width=0.27\textwidth]{figure/PredictiveModeling} }}%
    \qquad
    \subfloat{{\includegraphics[width=0.27\textwidth]{figure/RegressionModeling} }}
    \label{fig:example}%
\end{figure}
