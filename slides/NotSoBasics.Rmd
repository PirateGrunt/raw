...
If you understand vectors- how to create them, how to manipulate them, how to access the elements, you're well on your way to grasping how to handle other objects in R. Fundamentally, _everything_ in R is a vector sooner or later.
...
List the vectors in order by first name.

List the vectors in order by last name.

Create vector of years when someone named "George" was elected.
