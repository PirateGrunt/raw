...
TODO: add a Dave Clark and a bootstrap
...
```
```{r echo=FALSE, results='asis', size='huge', message=FALSE, tidy=FALSE, highlight=FALSE, eval=FALSE}
library(pander)
...
```{r eval=FALSE, fig.height=6, eval=FALSE}
